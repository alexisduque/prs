...
VERBOSE(server_params* sp, int level, char* fmt, ...)
{
  ...
  va_start(ap, fmt);   // va_start sert � gerer la va_list:
...
/****************************************************/
/* 
   raw_print: affichage propre en hexad�cimal et dans l'ordre r��l
   des octets d'une portion de m�moire 
 */
/****************************************************/
