...
int p2p_do_neighbors_req(server_params *sp, p2p_msg neighbors_req_msg) {
    ...
    // Création de la liste reponse et remplissage
    ...
    VERBOSE(sp,VPROTO,"UDP MSG SENT \n");
...
int p2p_do_neighbors_list(server_params *sp, p2p_msg neighbors_list_msg) {
    VERBOSE(sp,VPROTO, "Traitement du neihbors_list \n");


	printf("Traitement message NEIGHBORS_LIST \n");
	
	printf("recois Neighbors list de %s \n",p2p_addr_get_str(p2p_msg_get_src(neighbors_list_msg)));
